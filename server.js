...
/**
 * Turns a Pexels/Pixabay *webpage* link into the actual playable video
 * file URL by calling that platform's official API. Direct .mp4 links
 * (and anything from Coverr etc.) are passed through unchanged.
 */
async function resolveDirectVideoUrl(inputUrl) {
  ...
  // Coverr and anything else: try the link as-is
  return inputUrl;
}
